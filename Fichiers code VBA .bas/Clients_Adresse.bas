Attribute VB_Name = "Clients_Adresse"


Sub Attachement_Client_Adresse()


Range("G15") = InputBox("Insertion Nom et Prénom", "Clients")


End Sub


Sub Final_Client_Adresse()


Application.StatusBar = "Adresse"

Sheets.Add.Name = "Adresse"
    Cells.Select
    With Selection.Font
    ...
    End With
    Call Fiche_Client_Adresse
    Call Attachement_Client_Adresse
...
Sub Fiche_Client_Adresse()
    
    
    Call Mise_en_page_Client_Adresse
...
ActiveCell.Offset(0, 5).Range("A1").Select
    Selection.Borders(xlEdgeRight).LineStyle = xlContinuous
ActiveCell.Offset(1, -16).Range("A1:I1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
...
ActiveCell.Offset(0, -9).Range("A1:G1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    Selection.Interior.ColorIndex = 15
    ActiveCell.FormulaR1C1 = "Facturation"
ActiveCell.Offset(0, 2).Range("A1:G1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    Selection.Interior.ColorIndex = 15
    ActiveCell.FormulaR1C1 = "Livraison"
ActiveCell.Offset(0, -12).Range("A1:S1").Select
    Selection.Borders(xlEdgeBottom).LineStyle = xlContinuous
ActiveCell.Offset(2, 1).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "Titre"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "Nom et Prénom"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
...
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "Bureau"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "E-mail"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "Autre"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "No Facture"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "No Référance"
ActiveCell.Offset(2, 0).Range("A1:S1").Select
    ActiveCell.FormulaR1C1 = "Date"
ActiveCell.Offset(21, -1).Range("A1:C1").Select
    Selection.Borders(xlEdgeTop).LineStyle = xlContinuous
ActiveCell.Offset(0, 4).Range("A1:G1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    Selection.Interior.ColorIndex = 15
    ActiveCell.FormulaR1C1 = "Facturation"
...
Sub Mise_en_page_Client_Adresse()
