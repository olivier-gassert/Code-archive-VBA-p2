Attribute VB_Name = "Clients_Visites"


Sub Final_Client_Visites()


Application.StatusBar = "Visites"

Sheets.Add.Name = "Visites"
    Cells.Select
    With Selection.Font
...
Sub Fiche_Client_Visites()
    
    
    Call Mise_en_page_Client_Visites
...
ActiveCell.Offset(1, -16).Range("A1:Q1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    ActiveCell.FormulaR1C1 = "Visites"
...
ActiveCell.Offset(0, 2).Range("A1:O1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    Selection.Interior.ColorIndex = 15
    ActiveCell.FormulaR1C1 = "Raport"
ActiveCell.Offset(0, -4).Range("A1:S1").Select
    Selection.Borders(xlEdgeBottom).LineStyle = xlContinuous
ActiveCell.Offset(49, 0).Range("A1:C1").Select
    Selection.Borders(xlEdgeTop).LineStyle = xlContinuous
ActiveCell.Offset(0, 4).Range("A1:O1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    Selection.Interior.ColorIndex = 15
    ActiveCell.FormulaR1C1 = "Raport"
...
Sub Mise_en_page_Client_Visites()
