Attribute VB_Name = "Clients_Famille"


Sub Final_Client_Famille()


Application.StatusBar = "Famille"

Sheets.Add.Name = "Famille"
    Cells.Select
    With Selection.Font
...
Sub Fiche_Client_Famille()
    
    Call Mise_en_page_Client_Famille
...
ActiveCell.Offset(0, -9).Range("A1:C1").Select
    Selection.Merge
    Selection.HorizontalAlignment = xlCenter
    Selection.Interior.ColorIndex = 15
...
ActiveCell.Offset(0, 16).Range("A1:C1").Select
    Selection.Borders(xlEdgeTop).LineStyle = xlContinuous
...
Sub Mise_en_page_Client_Famille()
